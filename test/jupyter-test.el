...
(when jupyter-test-kernelgateway-p
  (message "Starting up kernelgateway process for tests")
  (start-process "jupyter-gateway" nil "jupyter" "kernelgateway"))
...
(ert-deftest jupyter-server ()
  :tags '(server)
  (skip-unless jupyter-test-kernelgateway-p)
