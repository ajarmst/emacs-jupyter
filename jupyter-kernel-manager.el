...
(cl-defgeneric jupyter-shutdown-kernel ((manager jupyter-kernel-manager) &rest _)
...
(cl-defgeneric jupyter-interrupt-kernel ((manager jupyter-kernel-manager) &rest _)
